...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=False,
        help=(
            "Whether to distill a pre-trained RDT model using DMD distillation into a one-step denoiser. "
            "If False, the model will be trained as a standard RDT model. "
            "If True, the model will be trained in a distillation mode, which requires passing `--pretrained_model_name_or_path`."
        )
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Whether or not to automatically adjust the brightness of the dark input images to a light value.",
    )
    parser.add_argument(
        "--image_aug",
        action="store_true",
    ...
    parser.add_argument("--hdf5_dir", type=str, default=None, help="For distributed training: path to the hdf5 dataset directory.")
    
    parser.add_argument("--webdataset_config", type=str, default=None, help="Path to the webdataset configuration file.")
